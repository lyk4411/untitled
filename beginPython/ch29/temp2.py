import pygame, beginPython.ch29.config, os
...
class SquishSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, image):
        ...
        shrink = -beginPython.ch29.config.margin * 2
...
class Weight(SquishSprite):
    ...
    def __init__(self, speed):
        SquishSprite.__init__(self, beginPython.ch29.config.weight_image)
        self.speed = speed
        self.reset()
...
class Banana(SquishSprite):
    ...
    def __init__(self):
        SquishSprite.__init__(self, beginPython.ch29.config.banana_image)
        ...
        self.pad_top = beginPython.ch29.config.banana_pad_top
        self.pad_side = beginPython.ch29.config.banana_pad_side
